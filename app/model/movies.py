...
def add_to_auto_complete_sorted_set(redis_handle, category, data):
    ...
    for l in range(1,len(n)):
        prefix = n[0:l]
        redis_handle.zadd(auto_complete_set, 0, prefix)
    redis_handle.zadd(auto_complete_set, 0, n+"*")
...
def get_movie_by_title(redis_handle, title):
    '''
    Given a movie title, return a list of the movie item.
    :param redis_handle:
    :param title:
    :return: A list of movie object.
    '''
    return list(redis_handle.smembers(title))
